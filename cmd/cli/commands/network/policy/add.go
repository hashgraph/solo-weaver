...
var addCmd = &cobra.Command{
	...
	Long: "Add CIDRs to the live nft set for a named policy (`nft add element inet weaver-blocknode-classifier <name> { … }`). " +
		"The set is mutated directly — no chain re-render and no update to network-weaver-blocknode-classifier.nft, because " +
