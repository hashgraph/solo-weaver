...
var installCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		inputs := models.ConsensusNodeInputs{
			...
			ApiPermissionFile:         flagApiPermissionFile,
			AppOverrideFile:           flagAppOverrideFile,
			BootstrapFile:             flagBootstrapFile,
			NodePropertiesFile:        flagNodePropertiesFile,
			FeeSchedulesFile:          flagFeeSchedulesFile,
