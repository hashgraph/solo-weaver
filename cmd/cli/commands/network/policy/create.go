...
var createCmd = &cobra.Command{
	Use:   "create",
	Short: "Create a policy: render its rule(s) into the `inet weaver-blocknode-classifier` chain",
	Long: "Render one named category's classification/ACL rule(s) into the `inet weaver-blocknode-classifier` forward chain and " +
