...
func newUpgradeHandler(base bll.BaseHandler[models.BlocknodeInputs], runtimeState EffectiveValueAccessor) *UpgradeHandler {
	return &UpgradeHandler{BaseHandler: base, effective: runtimeState}
}
