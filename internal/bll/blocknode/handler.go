...
func NewHandlerFactory(
	...
	v := runtimeValueAccessor{bn: runtime.BlockNodeRuntime}
	h := &HandlerFactory{
		install:   newInstallHandler(base, v, sm),
		upgrade:   newUpgradeHandler(base, v),
		reset:     newResetHandler(base, v),
		uninstall: newUninstallHandler(base, v),
	}
